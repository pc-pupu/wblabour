...
function init_chart_doughnut_edit(lc,b,f,s) {
    if ("undefined" != typeof Chart && (console.log("init_chart_doughnut"), $(".canvasDoughnut").length)) {
        var a = {
            type: "doughnut",
            tooltipFillColor: "rgba(51, 51, 51, 0.55)",
            data: {
                labels: ["LC", "BOILERS", "FACTORY", "SHOPS"],
                datasets: [{
                    data: [lc, b, f, s],
                    backgroundColor: ["#3498DB", "#E74C3C", "#26B99A", "#9B59B6"],
                    hoverBackgroundColor: ["#49A9EA", "#E95E4F", "#36CAAB", "#B370CF"]
                }]
            },
            options: {
                legend: !1,
...
function init_chart_doughnut() {
    if ("undefined" != typeof Chart && (console.log("init_chart_doughnut"), $(".canvasDoughnut").length)) {
        var a = {
            ...
            tooltipFillColor: "rgba(51, 51, 51, 0.55)",
            data: {
                labels: ["MTW", "ISMW", "BOCWA", "OTHER", "CLARA"],
                datasets: [{
                    data: [15, 20, 25, 10, 30],
...
function init_gauge() {
    if ("undefined" != typeof Gauge) {
        ...
        if ($("#gauge-text").length && (c.maxValue = 100, c.animationSpeed = 32, c.set(90), c.setTextField(document.getElementById("gauge-text"))), $("#chart_gauge_02").length) var d = document.getElementById("chart_gauge_02"),

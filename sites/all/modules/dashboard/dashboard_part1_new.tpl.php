      ...
      <div class="x_content graphbrdr">
        <table class="" style="width:100%">
           <tr style="display: inline-block">
            <td><canvas class="canvasDoughnut" height="150" width="150" style="margin-right:15px"></canvas></td></tr>
            <tr style="display: inline-block">
    ...
    <div class="x_content">
						...
						for($j=0;$j<sizeof($servicedata);$j++){
							...
							//echo "service_id-->".$servicedata[$j]->service_id."<br>";
							 for($k=0; $k<sizeof($tmp['list']); $k++){
								  ...
								  //echo "unique_id-->".$tmp['list'][$k]['ld_service_unique_id']."<br>"; 
								  
								 if(trim($servicedata[$j]->id) == trim($tmp['list'][$k]['ld_service_unique_id'])){
									...
									$newservicedata[$j]['e_name'] = $tmp['list'][$k]['factory_name'];
									$newservicedata[$j]['status'] = $tmp['list'][$k]['status'];
									//$newservicedata[$j]['final_submit_status'] = $tmp['list'][$k][0]['final_submit_status'];
									$newservicedata[$j]['application_date'] = $tmp['list'][$k]['payment_date'];
									$newservicedata[$j]['l_status'] = $tmp['list'][$k]['l_status'];
									$newservicedata[$j]['inspector_approval'] = $tmp['list'][$k]['inspector_approval'];
									$newservicedata[$j]['boiler_enroll_no'] = $tmp['list'][$k]['boiler_enroll_no'];
									$newservicedata[$j]['repairer_enroll_no'] = $tmp['list'][$k]['repairer_enroll_no'];
									$newservicedata[$j]['seen_status'] = $tmp['list'][$k]['seen_status'];
	  ...
	  ?>
        <div class="panel"> <a class="panel-heading collapsed" role="tab" id="headingFour" data-toggle="collapse" data-parent="#accordion" href="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
          <h4 class="panel-title">Shop & Establishment</h4> <span class="glyphicon glyphicon-plus pull-right"></span>
          </a>
        ...
        <div id="myModal" class="modal fade feedback" role="dialog" data-backdrop="static">
                    ...
                    <div class="evaluation">
                        ...
                        <div id="colorstar" class="starrr ratable" ></div>
                            ...
                            <div class="indicators" style="display:none">
								...
								<div class="button-checkbox-panel">
                                <span class="button-checkbox">
                                <button type="button" class="btn criteria buttondashboardstar" data-color="info">Information</button>
                                 <input type="checkbox" class="hidden" id="1" value="1_I"  />
                                 <input type="hidden" id="feedbackans_1" class="myoptnchk" value="NOVAL">
                                </span>
                                
                                <span class="button-checkbox">
                                <button type="button" class="btn criteria buttondashboardstar" data-color="info">Process</button>
                                 <input type="checkbox" class="hidden" id="2" value="2_S"  />
                                 <input type="hidden" id="feedbackans_2" class="myoptnchk" value="NOVAL">
                                </span>
                               
                                <span class="button-checkbox">
                                <button type="button" class="btn criteria buttondashboardstar" data-color="info">Payment</button>
                                 <input type="checkbox" class="hidden" id="3" value="3_P"  />
                                 <input type="hidden" id="feedbackans_3" class="myoptnchk" value="NOVAL">
                                </span>
                                
                                <span class="button-checkbox">
                                <button type="button" class="btn criteria buttondashboardstar" data-color="info"> Interface</button>
